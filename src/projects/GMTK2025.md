...
The beauty of this solution is that it reduced the coupling of the game class to the game objects, meaning that delete can be retruned and it will deled itsle ffrom the main list of objects.
...
These last two limitations were where a major bug in the development of the jam was hit. Chris, working without a debugger encountered this late one night before I wne tto bed with the player class having a stack allocated child
